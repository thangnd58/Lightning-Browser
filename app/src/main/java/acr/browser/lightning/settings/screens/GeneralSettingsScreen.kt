        ...
        content = listOf(
                    ...
                    onSelected = {
                        when (it) {
                            0, 1, 3 -> ClickableOnClick.Action {
                                userPreferencesDataStore.userAgentChoice.set(UserAgentChoice.entries[it])
                            }
                                ...
                                onValueUpdated = { value ->
                                    ClickableOnClick.Action {
                                        userPreferencesDataStore.userAgentChoice.set(UserAgentChoice.CUSTOM)
                                        userPreferencesDataStore.userAgentString.set(value)
                                    }
                                }
                            )
                        }
            ...
            ClickableState(
                ...
                onClick = ClickableOnClick.ItemSelector(
                    ...
                    onSelected = {
                        ClickableOnClick.Action {
                            userPreferencesDataStore.searchSuggestionChoice.set(Suggestions.entries[it])
                        }
                    },
                )
            )
